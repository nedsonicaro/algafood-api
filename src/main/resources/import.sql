...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, is_ativo, data_atualizacao, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Thai Gourmet', 10, 1, utc_timestamp, true, utc_timestamp, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, is_ativo, data_atualizacao) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, true, utc_timestamp);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, is_ativo, data_atualizacao) values (3, 'Tuk Tuk Comida Indiana', 15, 2, utc_timestamp, true, utc_timestamp);
